...
function create(options) {
  ...
  CustomizableUI.createWidget({
    ...
    onBuild: function(document) {
      ...
      var createMyMenuItem = function (parent,cid,label)
      {
      ...
      createMyMenuItem(menupopup,"edit_custom_rules",_("Edit_Custom_Rules"));
      createMyMenuItem(menupopup,"view_default_rules",_("View_Default_Rules"));
      // createMyMenuItem(menupopup,"menuitem-2","menuitem-2");
      // createMyMenuItem(menupopup,"menuitem-3","menuitem-3");
